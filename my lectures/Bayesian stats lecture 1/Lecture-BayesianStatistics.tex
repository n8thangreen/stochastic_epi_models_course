...
{\Huge{Lecture \vspace{5mm}\\Bayesian inference}}
...
\begin{itemize}
  \item List the fundamental components of Bayesian inference
  \vspace{2mm}
  \item Describe Bayes' Theorem
  \vspace{2mm}
  \item Describe what a conjugate model is and its features
  \vspace{2mm}
  \item Describe the conjugate Binomial-Beta, Normal-Normal and Poisson-Gamma models
    \vspace{2mm}
    \item Compare prior and posterior distributions
\end{itemize}
}
